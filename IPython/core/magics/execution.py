...
class ExecutionMagics(Magics):
    ...
    def profile_missing_notice(self, *args, **kwargs):
        """ called if profile module is missing"""
        error("""\
...
python-profiler package from non-free.""")
    ...
    def prun(self, parameter_s='', cell=None, user_mode=True,
        ...
        profile multi-line blocks without having to put them in a separate
        function.
        ...
        -l <limit>
                you can place restrictions on what or how much of the profile gets printed.
        ...
        -r
                return the `pstats.Stats` object generated by the profiling. This object has all the
                information about the profile in it, and you can later use it for further analysis
        ...
        -s <key>
                ...
                abbreviation is unambiguous.  The following keys are currently
                defined:
    ...
    def timeit(self, line='', cell=None):
        ...
        -n <N>
                execute the given statement <N> times in a loop. If this value
                is not given, a fitting value is chosen.
        -r <R>
                repeat the loop iteration <R> times and take the best result.
                Default: 3
        -t
    ...
    def macro(self, parameter_s=''):
        ...
        Notes
        -----
        As a "hidden" feature, you can also use traditional python slice
